...
PS.Config.CommunityName = "multigaming.community"
...
PS.Config.ShopCommand = 'shop' -- Console command to open the shop, set to blank to disable
...
PS.Config.PointsName = 'mgcoin' -- What are the points called?
